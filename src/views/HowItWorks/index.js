...
export default function GeneralInformation () {
	...
	const stepData = [
		...
		{
			title:"Step 2",
			mainTitle:"Identity<br/>Verification"
		},
		{
			title:"Step 3",
			mainTitle:"Wallet"
		...
		{
			title:"Step 5",
			mainTitle:"Review<br/>Documentation"
		},
		{
			title:"Step 6",
			mainTitle:"Select<br/>Investment<br/>Amount"
		},
		{
			title:"Step 7",
			mainTitle:"Secuure Payment<br/>via Mollie"
		},
		{
			title:"Step 8",
			mainTitle:"Success!"
	...
	useEffect(()=>{
		callGet("/api/getHowItWorksData").then(data1 => {
    ...
    return (
      <div>
			...
			<div style={{ padding: "2% 12% 2% 12%", backgroundColor:"#fff" }}>
				...
				<div className='work-title  text-center d-text-90 text-bold color-black'>
					<p>Get Started with eSTOOK</p>					
				</div>
                {
								...
								<div className="grid grid-flow-row" key={key}>
									{
										(value.step % 2 == 0)?(
											<div className="grid grid-flow-col max-h-100 mt-5 gap-5 grid-cols-2">
												...
												<div className="mt-10">
													<div className='row'>
														<div className='col-md-6 text-right vertical-center right-border'>
															<span className="d-font-bold d-text-72" style={{color:"#10d3c0", lineHeight:1}} dangerouslySetInnerHTML={{__html:stepD.mainTitle}}></span>
														</div>
														<div className='col-md-6 vertical-center'>
															<span className="d-font-bold d-text-90" style={{color:"#173039"}}>{stepD.title}</span>
														</div>
													</div>
													<Row>
													<ContentEditable
											...
											(value.step == 3)?(
												...
												<div className="mt-10">
													<div className='row'>
														<div className='col-md-6 text-right vertical-center'>
															<span className="d-font-bold d-text-90" style={{color:"#173039"}}>{stepD.title}</span>
														</div>
														<div className='col-md-6 text-left vertical-center left-border'>
															<span className="d-font-bold d-text-72" style={{color:"#10d3c0", lineHeight:1}} dangerouslySetInnerHTML={{__html:stepD.mainTitle}}></span>
														</div>
													</div>
													<div className='row'>
													...
													<div className='row'>
														<div className='col-md-5 border-style1 text-center d-text-18 center-text' style={{marginRight:'2%', marginTop: "2%"}}>Add your existing crypto wallet</div>
														<div className='col-md-5 border-style2 text-center d-text-18 'style={{marginLeft:'2%', marginTop: "2%"}}>
															<div className='row'>
																<div className='col-md-8 center-text'>Create a wallet using Metamask</div>
																<div className='col-md-4 center-text image-display'>
																<img src="/image/how_it_wokrs/meta.png" alt="" />
																</div>
															</div>
														</div>
													</div>
