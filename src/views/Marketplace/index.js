...
const Marketplace = connect(mapStateToProps, mapDispatchToProps)(class extends Component {
  ...
  render() {
    ...
    let sorted = products.sort(function(a, b) {
      let aValue = a.available || 0;
      let bValue = b.available || 0;
    ...
    return (
      <>
      <div style={{ paddingTop:"20%", paddingLeft: "20%" ,fontFamily:"Montserrat-Bold"}} className='img-box img-box-market'>
        <Fade>
          <div>
            <div className="d-white d-text-87" style={{ marginBottom: 12,  }}>
              {t("MarketPlace.eSTOKK Marketplace")}
            </div>
      ...
      <div style={{backgroundColor:"#fff", padding: "4% 12% 2% 12%",fontFamily:"Montserrat-Bold" }}>
        <div style={{ display: 'flex', alignItems: 'center'}}>
          ...
          <Dropdown>
            <Dropdown.Toggle id="dropdown-basic" className=" d-text-18 d-text-bold marketplace-dropdown"
          ...
          {products && sorted.length > 0 && sorted.map((product) => (
