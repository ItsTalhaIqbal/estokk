...
const Product  = connect(mapStateToProps, mapDispatchToProps)(class extends Component {
...
//		const totalPrice = this.props.productData.totalInvestment.toFixed(2).toLocaleString()
		...
		return (
			...
			{mode == "wide"?
			<Layout.Row>
			<Link to={`/product/${str1}-${str3}`}  onClick={this.onClick.bind(this)}>
			<Layout.Col span="24">
				...
				<div className="grid-content bg-purple" style={{position:"relative", display:"contents"}}>
					...
					<span className="d-font-bold d-text-36" style={{color:"white"}}>
					&nbsp;{address1 + ","}
					</span> &nbsp; &nbsp;
			...
			<div style={{marginTop:45, marginLeft:15, position:"absolute",backgroundColor:"#234e70", padding:"2px 0px", width:100, borderRadius:5}} >
				<img src="/imgs/marketplace/home.png" className="img-fluid ml-2"></img>
				<span className="d-text-36 ml-2" style={{color:"#0dbfcd"}}>{propertyClass}</span>
			</div>
			...
			:<div style={{
				...
				<div className="d-font-bold d-text-48 text-center" style={{color:"#0dbfcd"}}>
					{t("Product.SOLD OUT")}
				</div>
			...
			<div style={{
				...
				<div>
					...
					<div style={{marginTop:25, marginLeft:15, 
						backgroundColor:"#234e70", width:80, borderRadius:5, position:"absolute", padding:"4px"}}
				...
				<div style={{
					...
					<span className="d-highlight d-font-bold ">
						{address2}
					</span>
				</div>
				<div style={{
				...
				<div style={{
					...
					<div className="d-font-book d-text-60" style={{color: "#234e70"}}>
							{expectedROI + '%'}
				...
				<div style={{
					...
					<div className="d-font-bold d-text-48" style={{color: "#234e70"}}>
						{t("Product.AVAILABLE")}
					</div>
