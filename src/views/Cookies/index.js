...
export default function Cookies () {
	...
	useEffect(()=>{
		callGet("/api/getCookiesData").then(data1 => {
    ...
    return (
      <div>
			...
			<Fade>
				<div className="img-box img-box-cooki">
					...
					}
                  {
                    Object.entries(data).map(([key,value], i) => {
								...
								<div className="mb-3">
									{
										...
										<div className="d-content-blue d-font-black d-text-24 h-auto pb-2 pt-2 pl-4 pr-4" style={{ whiteSpace:'pre-wrap'}}>
											{value.title}
										</div>
										)
									}
										...
										Object.entries(value.content).map(([key__,value__], i__) => {
											return (
												<div className="grid grid-flow-col gap-4 grid-cols-8 mt-4">
													<div className=" text-white d-text-30 col-start-1 col-end-3 d-content-dark w-full p-2 grid" style={{backgroundColor:"#33454d"}}>
													...
													<div className=" text-white d-text-30 col-start-3 col-end-5 d-content-dark w-full p-2 grid" style={{backgroundColor:"#33454d"}}>
														<ContentEditable
                      ...
                      return <div className="nav-faq" style={{marginBottom:'20px'}} key={i}>
						...
						{
							userType==='ADMIN'?(
								<div className="d-content-dark pt-2 pl-2 pr-2" style={{backgroundColor:"#33454d"}}>
									<textarea
										id={`contentId-${i}`}
								...
								<div className="text-white d-text-24 d-content-dark pt-2 pl-4 pr-4" style={{ whiteSpace:'pre-wrap',backgroundColor:"#33454d"}}>
									{value.content}
                          		</div>
							)
						}
