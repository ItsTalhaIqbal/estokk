...
const typeOptions = [
  ...
  { key: "fourplex", label: "Fourplex House" },
...
const AdminPropertyNew = props => {
  ...
  const onFormChange = (key, value) => {
    ...
    } else if (key == 'generatedToken' || key == 'assetPrice' || key == 'renovationUpgrade' || key == 'operatingExpenseReimbursement' || key == 'vacancyReserve' || key =='administrativeFee' || key == 'initMaintainanceReserve' || key == 'initialRenovationReserve') {
      
      const value = parseFloat(formClone['assetPrice']) + 
                    parseFloat(formClone['renovationUpgrade'])+
                    parseFloat(formClone['operatingExpenseReimbursement'])+
                    parseFloat(formClone['vacancyReserve'])+
                    parseFloat(formClone['administrativeFee'])+
                    parseFloat(formClone['initMaintainanceReserve']) + 
                    parseFloat(formClone['initialRenovationReserve']);
      console.log(value);
      formClone['tokenValue'] = formClone['generatedToken'] != 0 ? (value / parseFloat(formClone['generatedToken'])).toFixed(2) : null;
    }
    if (key == 'assetPrice') {
              ...
              <div className="row">
                ...
                <div className="col-md-3 mt-4">
                  <Form.Item label="Utilities" prop="utility">
                    ...
                    <Input type="number" value={form.utility} onChange={val => onFormChange('utility', val)} />
                  </Form.Item>
                </div>
                <div className="col-md-3 mt-4">
