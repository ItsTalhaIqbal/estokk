      ...
      <div style={{ width: '80%' }}>
        <Fade bottom delay={200}>
          <Form model={form} rules={rules} labelWidth="100" className="login-ruleForm d-font-bold" labelPosition={"top"} style={{ border: "2px solid #03ffa4", margin: 20, borderRadius: 10 }}>
            ...
            <Form.Item label="Enable Get Access Page" prop="getAccess" className="m-3 mt-4">
              <Select className="w-100" value ={form.getAccess} onChange={val => onFormChange('getAccess', val)}>
