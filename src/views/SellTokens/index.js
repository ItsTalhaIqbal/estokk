...
export default function SellTokens() {
  ...
  useEffect(()=>{
    if(i18n.language  === "en"){
        setContent(editedData.en)
    }else if(i18n.language === "rus" ){
        setContent(editedData.rus)
    }else{
        setContent(editedData.zh)
    }
},[i18n.language])
  ...
  return !user?.id ? (
    ...
    <div style={{backgroundColor:"#fff"}}>
      ...
      <div style={{ margin: "6% 12% 2% 12%" }}>
        <div className="d-font-black d-text-48 d-color-blue" style={{color:"#"}}>
          {t("SellTokens.Tokens")}
          <span style={{ padding: '2%' }} />
          <img className="img-mobile" src="imgs/tokens/token.png" alt="Token" />
        </div>
        <div style={{ height: 24 }} />
        <div className=" d-font-mont-regular d-text-32" dangerouslySetInnerHTML={{__html:content?.sellTokens?.desc1}}>
            ...
            <div style={{ margin: "12% 16% 6% 16%" }}>
              ...
              <div className="row">
                <div className="col-md-2" style={{ marginTop: 30 }}>
                  <Button className="d-font-bold d-text-24 d-color-blue btn-second" style={{ width: '100%' }} >{t("SellTokens.SOLD OUT")}</Button>
                </div>
                <div className="col-md-5" style={{ marginTop: 30 }}>
                  <Button className="d-font-bold d-text-24 d-color-blue btn-second" style={{ width: '100%' }}>{t("SellTokens.UNDER RENOVATION")}</Button>
                </div>
                <div className="col-md-4 ml-8" style={{ marginTop: 30 }}>
                  <Button className="d-font-bold d-text-24 d-color-blue btn-second" style={{ width: '100%' }}>{t("SellTokens.OFFERING CLOSED")}</Button>
                </div>
              </div>
            </div>
          </Fade>
      ...
      <div style={{ margin: "6% 12% 0% 12%" }}>
        ...
        <div className="" style={{ borderRadius: '0 0 8px 8px', padding: '4% 2%', marginBottom: 36, backgroundColor:"#264857" }}>
          <div className="row">
        ...
        <div className="text-end" style={{ paddingBottom: 120 }}>
          <Button className="d-font-black d-text-24 btn-sell-token" style={{ width: '32%', maxWidth: 436, padding: '1% 0' }} disabled={!newOrder.isChecked} onClick={onSubmit}>{t("SellTokens.SELL TOKENS")}</Button>
        </div>
      </div>
    </div>
  )
