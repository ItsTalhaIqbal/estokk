  ...
  const handleKeyPress = (evt) => {
    ...
    if(evt.key === 'Enter'){
      if ( currentPage == 0) startSell();
        ...
        if(quizs[currentPage - 1].type == "TEXT" && textValue !== ""){
        ...
        <Fade bottom delay={500}>
          ...
          <div className="d-font-book text-center mt-10">
            <div className="d-text-48 d-highlight">
              Apply below to sell your property on eSTOOK.immo
            </div>
            <div className="d-text-32 d-black mt-3">
              Get an all cash offer, sell in a matter of days.
            </div>
        ...
        {quizs.map((item, index) => (
          ...
          >
            ...
            {item.type == "TEXT" ? (
              <div className="form-group ml-3 d-text-48 mt-3" style={{ width: "80%" }}>
                <input
                  ...
                  required
                  onChange={(e) =>{ console.log(textValue); setTextValue(e.target.value)}}
                ></input>
              </div>
            ) : (
              <div className="ml-3 mt-3 d-text-28">
                ...
                { item.panswer && JSON.parse(item.panswer).map((item1, index1) => (
                  <div
                    ...
                    onClick={() => clickedSingle(item1, item.type,item)}
            ...
            <div className="mt-7 ml-3">
              <Button
                onClick={() =>textValue !== ""|| clickedList.length
                > 0 ? saveNextPage(item, index) : alert('The Field is required')}
                className="d-text-24"
