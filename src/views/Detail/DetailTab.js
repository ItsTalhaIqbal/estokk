...
const DetailTab = (props) => {
    ...
    const detailData = [
        {
            icon:<GiPositionMarker color="#0dbfcd"/>,
        ...
        {
            icon:<BsCalendarDate color="#0dbfcd"/>,
            title:t("detail.Construction Year"),
            content:constructionYear
        },
        {
            icon:<BsArrowCounterclockwise color="#0dbfcd"/>,
            title:t("detail.Stories"),
            content:stories+ " Stories"
        },
        {
            icon:<TiInfoLargeOutline color="#0dbfcd"/>,
            title:t("detail.Total Units"),
            content:totalUnits
        },
        {
            icon:<RiHotelBedLine color="#0dbfcd"/>,
        ...
        {
            icon:<BsLayoutThreeColumns color="#0dbfcd"/>,
            title:t("detail.Heating"),
            content:heating,
        },
        {
            icon:<BsSnow2 color="#0dbfcd"/>,
            title:t("detail.Cooling"),
            content:cooling,
        },
        {
            icon:<HiOutlineHome color="#0dbfcd"/>,
            title:t("detail.Building Class"),
            content:buildingClass,
        },
        {
            icon:<HiOutlineUserGroup color="#0dbfcd"/>,
        ...
        {
            icon:<IoHammerOutline color="#0dbfcd"/>,
            title:t("detail.Renovated"),
            content:renovated,
        },
        {
            icon:<FiUser color="#0dbfcd"/>,
    ...
    return (
        <div style={{width:"90%"}}>
            ...
            <div style={{padding:"2% 0%", color:"#323a45"}} className="d-text-32">
