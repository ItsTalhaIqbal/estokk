        ...
        <div style={{width:"66%"}}>
            ...
            <div style={{margin:"5%"}}>
                <div className="d-flex justify-content-between">
                    ...
                    <span className="d-text-48 " style={{color:"#0dbfcd"}}>{identifier}</span>
                </div>
                <div className="d-flex justify-content-between mt-5" style={{borderBottom:"3px solid #000"}}>
                    ...
                    <span className="d-text-48 " style={{color:"#0dbfcd"}}>{generatedToken}</span>
                </div>
            </div>
            <div style={{ borderRadius:5, boxShadow:"4px 3px 22px #aaa"}}>
                ...
                <div style={{padding:"2% 5%", color:"#323a45"}} className="d-text-32 pb-5">
