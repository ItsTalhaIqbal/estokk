...
function AffiliateURLs () {
        ...
        const [pageURL, setpageUrl] = useState('https://eSTOOK.immo/#/')
        const [referralURL, setReferralURL] = useState('https://eSTOOK.immo/#/ref/'+user.username)
            ...
            <Layout.Row style={{border: "1px solid #03ffa4"}}>
                        ...
                        referralLink && <>
                            ...
                            <ul className="d-white">
                                <li>{t("affiliateDashboard.affiliateUrl.Copy the Dineli URL you want to link to, and simply replace")} <span
                                    className="d-font-bold">eSTOOK.immo</span> {t("affiliateDashboard.affiliateUrl.with the new URL in your affiliate link. Make sure to keep the")} <span
                ...
                <Layout.Row >
                    <Layout.Col span="24" className="text-white text-center pl-28 pr-28 pt-10 pb-10 border-green-400 border-t-2 border-b-0" style={{textAlign: "center", marginBottom: 30}}>
                        ...
                        <br/>
                        {t("affiliateDashboard.affiliateUrl.To request a payout of your accumulated Affiliate earnings, just email us at info@eSTOOK.immo! A Dineli representative will respond shortly to finalize your request.")}
                        <br/>
                        <br/>
                        <Button style={{background: "#03ffa4", color: "black"}} className="d-font-bold"
