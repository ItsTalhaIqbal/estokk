...
export const transferToken = async (endpoint, privateKey, fromAddress, toAddress, tokenAddress, tokenAmount, chainId, platform) => {
  const web3 = new Web3(new Web3.providers.HttpProvider(endpoint));
  ...
  try {
    ...
    //   tokenAmount = web3.utils.toWei(tokenAmount, 'Gwei');
