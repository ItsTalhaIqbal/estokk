    ...
    return (
      <Navbar expand="md" style={{margin:"0% 12%"}}>
        <Navbar.Brand href="#home">
          <img className="img-mobile" src={backMode == "light" ? "/imgs/logo_light.png": "/image/sell_token/logo.png"} alt="Logo" width="222" />
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav style={{ marginLeft: 'auto', flexDirection: 'column' }}>
            <div className="deskContent ms-auto">
              <Button className="d-font-bold d-text-nav" style={{ backgroundColor:"white", width: 135, height:30, padding:0, color:"#00dfc8" }}
                onClick={() => this.onClickedAffiliate()}>{t("header.Affiliate Program")}</Button>
              <div style={{ width: 12 }} />
              <Dropdown>
                <Dropdown.Toggle variant="secondary" id="dropdown-basic"
                  className="d-font-bold d-text-nav language-dropdown"
                  style={{ width: 130, borderRadius: 8, textAlign:"left", height:30,padding:"0 20px", backgroundColor:"#00b5c9", borderColor:"#00b5c9", color:"#00f6ff"}}>
                  {this.state.lang}
                </Dropdown.Toggle>
                <Dropdown.Menu>
              ...
              <Link to={`/cart/null`}>
                <div className="position-relative">
                  <img className="img-mobile ms-1" src="/image/cart.png" alt="cart" style={{width:"80%"}} />
            ...
            <div className="d-flex justify-content-end ms-auto flex-wrap mt-1">
              ...
              <Nav.Link href="#marketplace"  style={{letterSpacing:".40rem"}}>
                <div className="d-font-book hover-bg-dark trans-2 invest_size d-text-24">
                  {t("header.INVEST")}
                </div>
              </Nav.Link>
              ...
              {/* <Nav.Link href="#learn" style={{letterSpacing:".15rem"}}>
                <div className="d-white d-font-book d-text-nav hover-bg-dark trans-2">
                  {t("header.LEARN")}
                </div>
              </Nav.Link> */}
              ...
              <Dropdown>
              <Dropdown.Toggle variant="secondary" id="dropdown-basic"
                  className="d-white d-font-book d-text-nav hover-bg-dark trans-2"
                  style={{letterSpacing:".15rem", width: 130, borderRadius: 8, textAlign:"left", height:30,padding:"0 20px", backgroundColor:"#786e64", borderColor:"#786e64" }}>
                  LEARN
                </Dropdown.Toggle>
                
                <Dropdown.Menu>
                <Dropdown.Item><Nav.Link href="#sell-tokens" style={{letterSpacing:".15rem"}}>
                <div className="d-black d-font-book d-text-nav hover-bg-dark trans-2">
                  Learn
                </div>
              </Nav.Link></Dropdown.Item>
                  <Dropdown.Item><Nav.Link href="#" style={{letterSpacing:".15rem"}}>
                <div className="d-black d-font-book d-text-nav hover-bg-dark trans-2">
                  Help & FAQ
                </div>
              </Nav.Link></Dropdown.Item>
                  ...
                  <Dropdown.Item><Nav.Link href="#how-it-works" style={{letterSpacing:".15rem"}}>
                <div className="d-black d-font-book d-text-nav hover-bg-dark trans-2">
                  Learning Center
                </div>
              </Nav.Link></Dropdown.Item>
                    ...
                    <div className="d-white d-font-book d-text-nav position-relative hover-bg-dark trans-2 p-2 cursor-pointer" id='navbar-my-account' style={{ marginRight:"20px" }}>
                    <div>L E A R N</div>
                    <div className="position-absolute bg-dark d-none border border-1 border-secondary" style={{ minWidth: 220, right: 0, top: 30, height: 'fit-content' }} id="navbar-my-account-children">
                      <Nav.Link href="#learn">
                        <div className="d-highlight d-font-bold d-text-nav hover-bg-dark trans-2 px-1">Learn</div>
                      </Nav.Link>
                      <Nav.Link href="#">
                        <div className="d-highlight d-font-bold d-text-nav hover-bg-dark trans-2 px-1">Help & FAQ</div>
                      </Nav.Link>
                      <Nav.Link href="#how-it-works">
                        <div className="d-highlight d-font-bold d-text-nav hover-bg-dark trans-2 px-1">How it works</div>
                      </Nav.Link>

                      <Nav.Link href="#">
                        <div className="d-highlight d-font-bold d-text-nav hover-bg-dark trans-2 px-1">Learning Center</div>
                      </Nav.Link>
                   </div>
                  </div>
              ...
              <Nav.Link href="#team" style={{letterSpacing:".15rem"}}>
                <div className="d-white d-font-book d-text-nav hover-bg-dark trans-2">
                  {t("header.ABOUT")}
                </div>
              </Nav.Link>
              ...
              <Button className="d-font-bold d-text-nav ml-2" variant="default" 
                style={{ width: 225, height:35 , backgroundColor: backMode == "light"?"#2E2E2E":"#ffffff", padding:0,color: backMode == "light"?"#fff":"#00c1c9"  }}
                onClick={() => this.onClickedMarketPlace()}>{t("header.PROPERTIES")}</Button>
            </div>
