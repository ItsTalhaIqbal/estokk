  ...
  render() {
    ...
    return (
      ...
      <HashRouter>
        ...
        <Helmet>
          <title>{this.props.siteSettings?.[0]?.title?this.props.siteSettings?.[0]?.title:'eSTOOK.immo'}</title>
          <meta name="description" content={this.props.siteSettings?.[0]?.description?this.props.siteSettings?.[0]?.description:'eSTOOK.immo'} />
          <meta name="keywords" content={this.props.siteSettings?.[0]?.keywords?this.props.siteSettings?.[0]?.keywords:'eSTOOK.immo'} /> 
          <meta property="og:title" content="eSTOOK, Inc" />
          <meta property="og:site_name" content="eSTOOK, Inc" />
          <meta property="og:description" content="Fractional Investment in Tokenized Real Estate Assets" />
          <meta property="og:image" content="/imgs/home1.png" />
          <meta property="og:url" content="https://eSTOOK.immo" />
        </Helmet>
      </HashRouter>
    )
  }
