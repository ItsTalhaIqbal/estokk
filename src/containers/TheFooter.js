...
import editedData from "../edited.json"
export default function TheFooter(){
    ...
    const [footerContent,setFooterContent] = useState(editedData.footer.en)
    console.log(i18n.language)
    useEffect(()=>{
        if(i18n.language  === "en"){
            setFooterContent(editedData.footer.en)
        }else if(i18n.language === "rus" ){
            setFooterContent(editedData.footer.rus)
        }else if(i18n.language === "zh"){
            setFooterContent(editedData.footer.zh)
        }else{
            setFooterContent(editedData.footer.en);
        }
    },[i18n.language])
        ...
        return (
            <div style={{margin: "8% 12% 2% 12%"}}>
                        ...
                        <Col md="6">
                            <Row>
                                ...
                                <div className="mt-3 d-text-32">                                
                                    ...
                                    <br/>
                                    <Link to={'/invest'} className="text-decoration-none d-white">
                                        {t("footer.Invest")}
                                    </Link>
                                    <br/>
                                    <Link to={'/properties'} className="text-decoration-none d-white">
                                        {t("footer.Properties")}
                                    </Link>
                                    <br/>
                                    ...
                                    <br/>
                                    <Link to={'/t+'} className="text-decoration-none d-white">
                                        {t("footer.T+")}
                                    </Link>
                                    <br/>
                                    <Link to={'/learning'} className="text-decoration-none d-white">
                                        {t("footer.Learning")}
                                    </Link>
                                    <br/>
                                    <Link to={'/help-fap'} className="text-decoration-none d-white">
                                        {t("footer.Help & FAQ")}
                                    </Link>
                                    <br/>
                                ...
                                <Col md="6" className="d-flex justify-content-between flex-column">
                                    <div className="mt-3 d-text-32">                                
                                        <Link to={'/about-us'} className="text-decoration-none d-white">
                                            {t("footer.About Us")}
                                        </Link>
                                        <br/>
                                        <Link to={'/newsletter'} className="text-decoration-none d-white">
                                            {t("footer.Newsletter")}
                                        </Link>
                                        <br/>
                                        <Link to={'/press-release'} className="text-decoration-none d-white">
                                            {t("footer.Press Release")}
                                        </Link>
                                        <br/>
                                        ...
                                        <br/>
                                        <Link to={'/partner-estokk'} className="text-decoration-none d-white">
                                            {t("footer.Partner eSTOKK")}
                                        </Link>
                                        <br/>
                            ...
                            <Row>
                                <Button className="d-font-bold d-text-30 mt-3 mb-3 home-footer btn-affilit affilit-position" style={{ width: "15vw", height:48 }}
                                        onClick={() => onClickedAffiliate()}>{t("header.Affiliate Program")}</Button>
                            </Row>
                        </Col>                    
                        <Col md="6" span={3} className="d-flex flex-column justify-content-between card-contact">
                            <div style={{padding:"5% 10%"}}>

                                <div className="text-white d-text-32 mb-3">
                                    <div className="text-white d-text-32 mb-3" style={{borderBottom:"2px solid #00e1c8"}}>
                                        ADDRESS
                                    </div>
                                    <div className="address-custom ms-5" style={{fontFamily:"Montserrat-Regular", textAlign:"center"}} dangerouslySetInnerHTML={{__html:setting?.address || '14935 Shady Bend Dr, Houston, TX 77070'}}></div>
                            ...
                            <div className="d-white d-font-bold d-text-32 text-center mb-3">
                                <Button className="d-font-bold d-text-30 mt-3 home-footer btn-contact" style={{ width: "19vw", height:48 }}
                ...
                <div className="d-white d-font-book d-text-18" style={{textAlign: "justify"}}>
                    ...
                    <br/>
                    <br/>
                    {footerContent?.content2}
                </div>
                <div className="" style={{margin: "6% 0% 6% 0%"}}>
                    <Row>
                        <Col md="4">
                            <Link to={'/home'}><img style={{width:"12vw"}} className="img-mobile" src={backMode=="light"?"/imgs/logo2_light.png":"/image/Team/logo.png"} alt="Logo"/></Link>
                        </Col>
                        <Col md="8" style={{ paddingRight:0,}}>
                            ...
                            <div style={{marginBottom: "20px"}} className='d-white mt-3 d-flex justify-content-end align-items-end'>
                                <span className="me-3">&copy;2022 eSTOOK</span>
