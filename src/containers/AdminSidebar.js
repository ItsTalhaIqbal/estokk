...
const menu = [
  {
    ...
    groupItems: [            
      ...
      { key: 'sellmyproperty', to: '/admin/sell-my-property', name: 'Sell My Property', icon:ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'howworks', to:'/admin/howworks', name:'HowWorks', icon:ReferralSvg, iconActive:ReferralOnSvg},
      ...
      { key: 'selltoken', to: '/admin/selltoken', name: 'SellToken', icon: ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'credential', to: '/admin/credential', name: 'Credential', icon: ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'newsletter', to: '/admin/newsletter', name: 'Newsletter', icon: ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'yam', to: '/admin/yam', name: "Yam", icon: ReferralSvg, iconActive: ReferralOnSvg},
      { key: 'tokengnerator', to: '/admin/token-generator', name: 'TokenGenerator', icon:ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'schedules', to: '/admin/schedules', name: 'Schedules', icon: ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'scheduler', to: '/admin/scheduler', name: 'Rent', icon: ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'whitelist', to: '/admin/whitelist', name: 'Whitelist', icon:ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'commission', to: '/admin/commission', name: 'Commission', icon:ReferralSvg, iconActive: ReferralOnSvg } 
    ]
  },
  {
    groupName: 'ACCOUNT',
